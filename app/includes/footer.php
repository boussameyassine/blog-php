<div class="footer">
    <div class="footer-content">
      <div class="footer-section about">
        <h1 class="logo-text">YAS<span>SINE</span></h1>
        <p>
          YASSINE is a fictional blog conceived for the purpose
          of a tutorial on YouTube. However, YAS has a blog called pieceofadvice.org
    ...
    <div class="footer-bottom">
      <p>© Coding Poets | Designed by YAS SINE</p>
    </div>
    </div>