        ...
        <table>
          ...
          <?php foreach ($posts as $key => $post): ?>
            ...
            <tr class="rec">
              ...
              <?php if ($post['published']): ?><td>
              <td>
                <a href="edit.php?published=0&p_id=<?php echo $post['id'] ?>" class="unpublish">Unpublish</a></td>
              <?php else: ?>  
                <td>
                <a href="edit.php?published=1&p_id=<?php echo $post['id'] ?>" class="publish">Publish</a></td>
              <?php endif; ?>
                </td>
            </tr>
